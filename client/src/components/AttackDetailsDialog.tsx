...
export default function AttackDetailsDialog({
  ...
  const [landingOutType, setLandingOutType] = useState<LandingOutType | null>(null);
  ...
  const handleConfirm = () => {
    onConfirm({
      ...
      landingX,
      landingY,
      landingOutType: landingOutType ?? undefined,
    });
    onOpenChange(false);
    setStep(1);
    setAttackPosition("1");
          ...
          {step === 5 && (
            <div>
              ...
              <div className="flex gap-3 mb-4">
                <button
                  className={`flex-1 h-14 rounded-xl border-2 font-semibold text-base transition-all duration-200 ${
                    landingOutType === "out"
                      ? "bg-orange-500 text-white border-orange-500 scale-105 shadow-lg"
                      : "bg-white border-gray-200 hover:border-orange-300 hover:shadow-md"
                  }`}
                  onClick={() => {
                    setLandingOutType("out");
                    setLandingX(0);
                    setLandingY(0);
                  }}
                >
                ...
                <button
                  className={`flex-1 h-14 rounded-xl border-2 font-semibold text-base transition-all duration-200 ${
                    landingOutType === "block_out"
                      ? "bg-purple-500 text-white border-purple-500 scale-105 shadow-lg"
                      : "bg-white border-gray-200 hover:border-purple-300 hover:shadow-md"
                  }`}
                  onClick={() => {
                    setLandingOutType("block_out");
                    setLandingX(0);
                    setLandingY(0);
                  }}
                >
              ...
              <div className="relative">
                ...
                >
                  ...
                  {/* 着弾点マーカー */}
                  {!landingOutType && landingX > 0 && landingY > 0 && (
                    <div
              ...
              <div className="flex gap-3 pt-4">
                ...
                <Button
                  ...
                  disabled={!landingOutType && (landingX === 0 || landingY === 0)}
                >
                  記録する
                </Button>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-4 mt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge className={landingOutType ? "bg-orange-500" : "bg-blue-500"}>
                    {landingOutType === "out"
                      ? "アウト"
                      : landingOutType === "block_out"
                      ? "ブロックアウト"
